        ...
        section();
          ...
          let phone_icons_list = ["../img/icon/phone.png", "../img/icon/whatsapp.png", "../img/icon/viber.png"];
            let phone_icons = document.querySelector('.phone_icons');
              setInterval(() => {
                let phoneIndex = Math.floor(Math.random() * phone_icons_list.length);
                  phone_icons.src = phone_icons_list[phoneIndex];
              }, 2000);
};
...
function slaid_vacation() {
  ...
  let image_list = [
    ...
    var tours_list = [
      "ქათქათა ბაკურიანი",
        "თვალისმომჭრელი რაბათი",
          "დაუვიწყარი ყაზბეგი",
            "ულამაზესი ბათუმი",
              "ანანურის გასაოცარი ბუნება",
                "ისტორიული ვარძია",
                  "წარმოუდგენელი კახეთი",
                    "ულამაზესი თბილისი",
                      "დაუვიწყარი წალკა",
                      ...
                      let turs_info_satauri = document.getElementById('turs_info_satauri');
                        let mandzili = document.getElementById('mandzili');
                            turs_info_satauri.textContent = tours_list[index];
                              mandzili.textContent = tours_mandzili[index] + "კმ.  თბილისიდან";
